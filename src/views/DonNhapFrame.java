 ...
 * @author
 */
public class DonNhapFrame extends javax.swing.JFrame {

    private final String[] tieuDe = {"STT", "Mã đơn nhập", "Ngày nhập", "Mã đơn đặt hàng"};
    ...
    public void hienThiDanhSach() {
        danhsach = new DonNhapDao().layDanhSachPhanTu();
        model.setRowCount(0);
        for (DonNhap ptu : danhsach) {
            model.addRow(new Object[]{
                model.getRowCount() + 1, ptu.getMaDonNhap(), new SimpleDateFormat("dd/MM/yyyy").format(ptu.getNgayNhap()), ptu.getMaDonDH()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Quản lý đơn hàng nhập");

        jLabel1.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Quản lý đơn hàng nhập");
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemMoiActionPerformed
        DonNhapFormFrame form = new DonNhapFormFrame(this, rootPaneCheckingEnabled);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (isXoa == 0) {
            if (new DonNhapDao().xoaPhanTu(danhsach.get(viTri))) {
    ...
    private void btnChiTietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChiTietActionPerformed
        CTDonNhapFrame form = new CTDonNhapFrame(this, rootPaneCheckingEnabled);
        form.layThongTinNhanDuoc(danhsach.get(viTri).getMaDonNhap());
        form.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonNhapFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
