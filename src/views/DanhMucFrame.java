...
public class DanhMucFrame extends javax.swing.JFrame {
    ...
    private final String[] tieuDe = {"STT", "Mã danh mục", "Tên danh mục"};
    private ArrayList<DanhMuc> danhsach = new ArrayList<>();
    private int viTri;
    ...
    public void hienThiDanhSach() {
        danhsach = new DanhMucDao().layDanhSachPhanTu();
        model.setRowCount(0);
        for (DanhMuc ptu : danhsach) {
            model.addRow(new Object[]{
                model.getRowCount() + 1, ptu.getMaDanhMuc(), ptu.getTenDanhMuc()
            });
        }
    }
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemMoiActionPerformed
        DanhMucFormFrame form = new DanhMucFormFrame(this, rootPaneCheckingEnabled);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (isXoa == 0) {
            if (new DanhMucDao().xoaPhanTu(danhsach.get(viTri))) {
