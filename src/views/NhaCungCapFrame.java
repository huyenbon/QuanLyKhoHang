 ...
 * @author
 */
public class NhaCungCapFrame extends javax.swing.JFrame {

    private final String[] tieuDe = {"STT", "Mã nhà cung cấp", "Tên nhà cung cấp", "Địa chỉ", "Số điện thoại"};
    ...
    public void hienThiDanhSach() {
        danhsach = new NhaCungCapDao().layDanhSachPhanTu();
        model.setRowCount(0);
        for (NhaCungCap ptu : danhsach) {
            model.addRow(new Object[]{
                model.getRowCount() + 1, ptu.getMaNhaCC(), ptu.getTenNhaCC(), ptu.getDiaChi(), ptu.getSoDienThoai()
            });
        }
    }
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemMoiActionPerformed
        NhaCungCapFormFrame form = new NhaCungCapFormFrame(this, rootPaneCheckingEnabled);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (isXoa == 0) {
            if (new NhaCungCapDao().xoaPhanTu(danhsach.get(viTri))) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhaCungCapFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
