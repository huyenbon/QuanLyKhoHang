...
import controller.CTDonNhapDao;
 ...
 * @author
 */
public class CTDonNhapFrame extends javax.swing.JDialog {

    private DonNhapFrame home;
    private String maDonNhap = null;
    private ArrayList<SanPham> dsSanPham = new ArrayList<>();
    private String[] dsTenSanPham;
    private DefaultTableModel model;
    private final String[] tieuDe = {"STT", "Mã sản phẩm", "Tên sản phẩm", "Số lượng nhập"};
    private ArrayList<CTDonNhap> dsCTDonNhap = new ArrayList<>();
    private int viTri;

    /**
     * Creates new form CTPhieuNhapFrame
     */
    public CTDonNhapFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     */
    public void hienThi() {
        dsCTDonNhap = new CTDonNhapDao().layDanhSachPhanTu(maDonNhap);
        model.setRowCount(0);
        for (CTDonNhap ptu : dsCTDonNhap) {
            model.addRow(new Object[] {
                model.getRowCount() + 1, ptu.getMaSanPham(), ptu.getTenSanPham(), ptu.getSoLuongNhap()
            });
        }
    }
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemMoiActionPerformed
        ...
        if(isDone) {
            CTDonNhap ptu = new CTDonNhap(maDonNhap, maSanPham, soLuong, donGia);
            if(new CTDonNhapDao().themPhanTu(ptu)) {
    ...
    private void tblDanhSachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDanhSachMouseClicked
        ...
        if(viTri > -1) {
            ...
            txtSoLuong.setText("" + ptu.getSoLuongNhap());
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatActionPerformed
        ...
        if(isDone) {
            CTDonNhap ptu = new CTDonNhap(maDonNhap, maSanPham, soLuong, donGia);
            if(new CTDonNhapDao().capNhatPhanTu(ptu)) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if(isXoa == 0) {
            CTDonNhap ptu = dsCTDonNhap.get(viTri);
            if(new CTDonNhapDao().xoaPhanTu(ptu)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CTDonNhapFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CTDonNhapFrame dialog = new CTDonNhapFrame(new javax.swing.JFrame(), true);
